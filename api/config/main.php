    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'GET item/<id:\d+>' => 'item/view',
                'GET item/category/<id:\d+>' => 'item/category',
                'GET item/tag/<id:\d+>' => 'item/tag',
                'GET items' => 'item/index',
                'items/<id:\d+>/stock' => 'stock/add',
                'GET stock' => 'stock/index',
                'DELETE stock-temporary' => 'stock-temporary/clear',
                'PUT stock/<id:\d+>/quantity' => 'stock/quantity',
                'DELETE stock/<id:\d+>' => 'stock/delete',
                'stock/checkout' => 'checkout/index',
            ],
        ],
    ],
    'as authenticator' => [
